...
declare module "@salesforce/schema/AccountChangeEvent.contact_count__c" {
  const contact_count__c:number;
  export default contact_count__c;
}
...
declare module "@salesforce/schema/AccountChangeEvent.Support_Plan_Start_Date__c" {
  const Support_Plan_Start_Date__c:any;
  export default Support_Plan_Start_Date__c;
}
