...
declare module "@salesforce/schema/Contact.Account_Manager__r" {
  const Account_Manager__r:any;
  export default Account_Manager__r;
}
declare module "@salesforce/schema/Contact.Account_Manager__c" {
  const Account_Manager__c:any;
  export default Account_Manager__c;
}
...
declare module "@salesforce/schema/Contact.Type__c" {
...
declare module "@salesforce/schema/Contact.Invoice_Email__c" {
  const Invoice_Email__c:boolean;
  export default Invoice_Email__c;
}
