Webruntime.define('lwc/calculator', ['lwc', 'lightning/configProvider', 'c/calculatorResult'], function (lwc, configProvider, _cCalculatorResult) { 'use strict';

    _cCalculatorResult = _cCalculatorResult && Object.prototype.hasOwnProperty.call(_cCalculatorResult, 'default') ? _cCalculatorResult['default'] : _cCalculatorResult;
    ...
    * */
    ...
    if (_implicitStylesheets$5) {
      tmpl$m.stylesheets.push.apply(tmpl$m.stylesheets, _implicitStylesheets$5);
    }
    ...
    function tmpl$q($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 0,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.handleName))
        }
      }, []), api_custom_element("lightning-input", _lightningInput, {
        props: {
          "label": "Last Name",
        ...
        key: 1,
        on: {
          "change": _m1 || ($ctx._m1 = api_bind($cmp.handleName))
        }
      }, []), api_custom_element("lightning-input", _lightningInput, {
        props: {
          "type": "checkbox"
        ...
        key: 2,
        on: {
          "change": _m2 || ($ctx._m2 = api_bind($cmp.displayName))
        }
      }, [])]), $cmp.isActive ? api_element("div", {
        key: 5
      }, [api_element("p", {
        key: 4
      }, [api_text("Hello! "), api_dynamic($cmp.fname), api_text(", "), api_dynamic($cmp.lname)])]) : null, api_iterator($cmp.namearray, function (name) {
        return [api_dynamic(name), api_text(", \xA0")];
      }), api_element("br", {
        key: 6
      }, []), api_iterator($cmp.namearray, function (nameValue, nameIndex, nameFirst, nameLast) {
        return [!nameLast ? api_element("div", {
          key: api_key(7, nameValue)
        }, [api_text(" "), api_dynamic(nameValue), api_text(", \xA0")]) : null, nameLast ? api_element("div", {
          key: api_key(8, nameValue)
        }, [api_text(" "), api_dynamic(nameValue), api_text(" ")]) : null];
        ...
        key: 10,
        on: {
          "change": _m3 || ($ctx._m3 = api_bind($cmp.compute))
        }
      }, []), api_custom_element("lightning-input", _lightningInput, {
        props: {
          "label": "Last Number",
        ...
        key: 11,
        on: {
          "change": _m4 || ($ctx._m4 = api_bind($cmp.compute))
        }
      }, []), api_custom_element("c-calculator-result", _cCalculatorResult, {
        props: {
          "calculatedResult": $cmp.result
        },
        key: 12
        ...
        key: 13,
        on: {
          "click": _m5 || ($ctx._m5 = api_bind($cmp.calculate))
        }
      }, []), api_custom_element("lightning-button", _lightningButton, {
        props: {
          "name": "Substract",
        ...
        key: 14,
        on: {
          "click": _m6 || ($ctx._m6 = api_bind($cmp.calculate))
        }
      }, []), api_custom_element("lightning-button", _lightningButton, {
        props: {
          "name": "Multiply",
        ...
        key: 15,
        on: {
          "click": _m7 || ($ctx._m7 = api_bind($cmp.calculate))
        }
      }, []), api_custom_element("lightning-button", _lightningButton, {
        props: {
          "name": "Divide",
        ...
        key: 16,
        on: {
          "click": _m8 || ($ctx._m8 = api_bind($cmp.calculate))
        }
      }, [])])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        props: {
          "size": "12"
    ...
    class Calculator extends lwc.LightningElement {
      constructor(...args) {
        ...
        this.namearray = ['Mani', 'Rakesh', 'Shankar', 'vignesh'];
        this.valueX = void 0;
        this.valueY = void 0;
        this.result = void 0;
      }
      ...
      handleName(event) {
        if (event.target.name == "fName") this.fname = event.target.value;else event.target.name == "lName";
      ...
      compute(event) {
        if (event.target.name == "x") this.valueX = event.target.value;else event.target.name == "y";
        this.valueY = event.target.value;
      }

      calculate(event) {
        if (event.target.label == "+") this.result = parseInt(this.valueX) + parseInt(this.valueY);else if (event.target.label == "*") this.result = parseInt(this.valueX) * parseInt(this.valueY);else if (event.target.label == "-") this.result = parseInt(this.valueX) - parseInt(this.valueY);else if (event.target.label == "/") this.result = parseInt(this.valueX) / parseInt(this.valueY);
      }

    }

    lwc.registerDecorators(Calculator, {
      fields: ["fname", "lname", "isActive", "namearray", "valueX", "valueY", "result"]
    });
