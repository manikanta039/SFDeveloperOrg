Webruntime.define('lwc/paginator', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';

    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".nav-info" + shadowSelector + " {text-align: center;}\n.nav-next" + shadowSelector + " {text-align: right;height: 32px;}\n";
    }
    ...
    **/
    ...
    function tmpl$6($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-layout", _lightningLayout, {
        classMap: {
          "slds-m-horizontal_x-small": true
        },
        props: {
        ...
        key: 1
      }, [!$cmp.isFirstPage ? api_custom_element("lightning-button-icon", _lightningButtonIcon, {
        props: {
      ...
      }, []) : null]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        classMap: {
          "nav-info": true
        },
        props: {
        ...
        key: 2
      }, [api_dynamic($cmp.totalItemCount), api_text(" items \u2022 page "), api_dynamic($cmp.currentPageNumber), api_text(" of "), api_dynamic($cmp.totalPages)]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        classMap: {
          "nav-next": true
        },
        props: {
        ...
        key: 4
      }, [!$cmp.isLastPage ? api_custom_element("lightning-button-icon", _lightningButtonIcon, {
        props: {
    ...
    tmpl$6.stylesheetTokens = {
      hostAttribute: "lwc-paginator_paginator-host",
      shadowAttribute: "lwc-paginator_paginator"
    };

    class Paginator extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.pageNumber = void 0;
        this.pageSize = void 0;
        this.totalItemCount = void 0;
      }
    ...
    lwc.registerDecorators(Paginator, {
      publicProps: {
        pageNumber: {
          config: 0
        },
    ...
    var paginator = lwc.registerComponent(Paginator, {
      tmpl: _tmpl$7
    });
