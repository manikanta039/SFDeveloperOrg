Webruntime.define('lwc/inlineMessage', ['lwc', 'lightning/configProvider', 'c/ldsUtils'], function (lwc, configProvider, ldsUtils) { 'use strict';

    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return "\n" + (nativeShadow ? (":host > div" + shadowSelector + " {text-align: center;}") : (hostSelector + " > div" + shadowSelector + " {text-align: center;}")) + "\n";
    }
    ...
    **/
    ...
    if (_implicitStylesheets$4) {
      tmpl$c.stylesheets.push.apply(tmpl$c.stylesheets, _implicitStylesheets$4);
    }
    ...
    */
    ...
    if (_implicitStylesheets$2) {
      tmpl$k.stylesheets.push.apply(tmpl$k.stylesheets, _implicitStylesheets$2);
    }
    ...
    * */
    ...
    function tmpl$l($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        key: 1
      }, [api_dynamic($cmp.message)]), $cmp.errorMessages.length ? api_flatten([api_element("div", {
        classMap: {
      ...
      }, [])]), $cmp.viewDetails ? api_iterator($cmp.errorMessages, function (message) {
        return api_element("p", {
          key: api_key(4, message)
        }, [api_dynamic(message)]);
      }) : []]) : []]))])];
    }
    ...
    tmpl$l.stylesheetTokens = {
      hostAttribute: "lwc-inlineMessage_inlineMessage-host",
      shadowAttribute: "lwc-inlineMessage_inlineMessage"
    };
    ...
    class InlineMessage extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.message = 'Error retrieving data';
        this.iconName = VARIANTS.info;
        this._variant = 'info';
      ...
      get errorMessages() {
        return ldsUtils.reduceErrors(this.errors);
      }
    ...
    lwc.registerDecorators(InlineMessage, {
      publicProps: {
        message: {
          config: 0
        },
    ...
    var inlineMessage = lwc.registerComponent(InlineMessage, {
      tmpl: _tmpl$k
    });
