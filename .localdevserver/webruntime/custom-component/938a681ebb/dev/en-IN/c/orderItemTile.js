Webruntime.define('lwc/orderItemTile', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';

    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".content" + shadowSelector + " {padding: 8px 8px 12px 8px;background-color: #ffffff;position: relative;border-radius: 0.25rem;}\nimg.product" + shadowSelector + " {height: 120px;max-width: initial;}\n.title" + shadowSelector + " {font-weight: bold;text-transform: uppercase;}\n.quantity" + shadowSelector + " {width: 58px;margin: 0 2px;}\n.price" + shadowSelector + " {width: 94px;margin: 0 2px;}\n.form" + shadowSelector + " {display: flex;}\n.save-button" + shadowSelector + " {position: absolute;top: 10px;right: 10px;}\n.delete-button" + shadowSelector + " {position: absolute;top: 10px;left: 10px;display: none;}\n.content:hover" + shadowSelector + " .delete-button" + shadowSelector + " {display: inherit;}\n";
    }
    ...
    **/
    ...
    if (_implicitStylesheets$5) {
      tmpl$c.stylesheets.push.apply(tmpl$c.stylesheets, _implicitStylesheets$5);
    }
    ...
    * */
    ...
    function tmpl$m($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        attrs: {
          "src": $cmp.orderItem.Product__r.Picture_URL__c,
          "alt": "Product picture"
        },
        key: 0
      }, []), api_element("p", {
        ...
        key: 1
      }, [api_dynamic($cmp.orderItem.Product__r.Name)]), api_element("p", {
        classMap: {
          "slds-align_absolute-center": true
        },
        key: 3
      }, [api_text("MSRP:"), api_custom_element("lightning-formatted-number", _lightningFormattedNumber, {
        props: {
          "value": $cmp.orderItem.Product__r.MSRP__c,
        ...
        attrs: {
          "data-field-name": "Price__c"
        },
        props: {
          "value": $cmp.orderItem.Price__c,
          "label": "Price",
          "type": "number",
          "formatter": "currency"
        },
        ...
        attrs: {
          "data-field-name": "Qty_M__c"
        },
        props: {
          "value": $cmp.orderItem.Qty_M__c,
          "label": "Medium",
          "type": "number",
          "maxLength": "3"
        },
        ...
        attrs: {
          "data-field-name": "Qty_L__c"
        },
        props: {
          "value": $cmp.orderItem.Qty_L__c,
          "label": "Large",
          "type": "number",
          "maxLength": "3"
        },
        ...
        key: 9,
        on: {
          "click": _m4 || ($ctx._m4 = api_bind($cmp.deleteOrderItem))
        }
      }, []), $cmp.isModified ? api_custom_element("lightning-button-icon", _lightningButtonIcon, {
        classMap: {
          "save-button": true
        },
        props: {
        ...
        key: 10,
        on: {
          "click": _m5 || ($ctx._m5 = api_bind($cmp.saveOrderItem))
        }
      }, []) : null])])];
    }
    ...
    tmpl$m.stylesheetTokens = {
      hostAttribute: "lwc-orderItemTile_orderItemTile-host",
      shadowAttribute: "lwc-orderItemTile_orderItemTile"
    };
    ...
    class OrderItemTile extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
    ...
    lwc.registerDecorators(OrderItemTile, {
      publicProps: {
        orderItem: {
          config: 0
        }
    ...
    var orderItemTile = lwc.registerComponent(OrderItemTile, {
      tmpl: _tmpl$l
    });
