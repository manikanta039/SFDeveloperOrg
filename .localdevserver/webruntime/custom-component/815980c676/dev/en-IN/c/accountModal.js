Webruntime.define('lwc/accountModal', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    **/
    ...
    function tmpl$4($api, $cmp, $slotset, $ctx) {
      ...
      return [$cmp.showModal ? api_element("div", {
        key: 11
      }, [api_element("section", {
        classMap: {
          "slds-modal": true,
        ...
        key: 2
      }, [api_text("New Account")])]), api_element("div", {
        classMap: {
    ...
    tmpl$4.stylesheetTokens = {
      hostAttribute: "lwc-accountModal_accountModal-host",
      shadowAttribute: "lwc-accountModal_accountModal"
    };

    class AccountModal extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
    ...
    lwc.registerDecorators(AccountModal, {
      publicProps: {
        showModal: {
          config: 0
        }
    ...
    var accountModal = lwc.registerComponent(AccountModal, {
      tmpl: _tmpl$5
    });
