Webruntime.define('lwc/productCard', ['lwc', 'lightning/configProvider', 'c/placeholder', 'c/inlineMessage', 'lightning/navigation', 'wire-service', 'instrumentation/service', 'aura-storage', 'aura', 'c/pubsub'], function (lwc, configProvider, _cPlaceholder, _cInlineMessage, navigation, wireService, service, auraStorage, aura, pubsub) { 'use strict';
    ...
    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return "img.product" + shadowSelector + " {width: 100%;margin-bottom: 8px;}\n.row" + shadowSelector + " {display: flex;border-bottom: solid 1px #f3f2f2;}\n.row" + shadowSelector + " div:first-child" + shadowSelector + " {width: 80px;}\n.row" + shadowSelector + " div:nth-child(2)" + shadowSelector + " {flex: 1;}\nsection" + shadowSelector + " {font-weight: bold;font-size: 13px;margin-top: 8px;text-transform: uppercase;}\n.price" + shadowSelector + " {color: #c23335;}\n";
    }
    ...
    **/
    ...
    function tmpl$7($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 40
      }, [$cmp.product.data ? api_element("span", {
        attrs: {
          "slot": "title"
        },
        key: 0
      }, [api_dynamic($cmp.product.data.fields.Name.value)]) : null, $cmp.product.data ? api_custom_element("lightning-button-icon", _lightningButtonIcon, {
        attrs: {
          "slot": "actions"
        },
        props: {
        ...
        key: 1,
        on: {
          "click": _m0 || ($ctx._m0 = api_bind($cmp.handleNavigateToRecord))
        }
      }, []) : null, $cmp.product.data ? api_element("div", {
        classMap: {
          "slds-m-horizontal_medium": true
        },
        key: 37
      }, [api_element("img", {
        classMap: {
        ...
        attrs: {
          "src": $cmp.product.data.fields.Picture_URL__c.value,
          "alt": "Product picture"
        },
        key: 2
      }, []), api_element("div", {
        ...
        key: 3
      }, [api_text("Category:")]), api_element("div", {
        key: 4
      }, [api_dynamic($cmp.product.data.fields.Category__c.value)])]), api_element("div", {
        classMap: {
          "row": true
        },
        key: 8
        ...
        key: 6
      }, [api_text("Level:")]), api_element("div", {
        key: 7
      }, [api_dynamic($cmp.product.data.fields.Level__c.value)])]), api_element("div", {
        classMap: {
          "row": true
        },
        key: 12
        ...
        key: 9
      }, [api_text("MSRP:")]), api_element("div", {
        key: 11
      }, [api_custom_element("lightning-formatted-number", _lightningFormattedNumber, {
        classMap: {
          "price": true
        },
        props: {
          ...
          "currencyCode": "USD",
          "value": $cmp.product.data.fields.MSRP__c.value
        },
        key: 10
      }, [])])]), api_element("section", {
        key: 13
      }, [api_text("Electric Components")]), api_element("div", {
        classMap: {
          "row": true
        },
        key: 16
        ...
        key: 14
      }, [api_text("Battery:")]), api_element("div", {
        key: 15
      }, [api_text("500Wh")])]), api_element("div", {
        classMap: {
          "row": true
        },
        key: 19
        ...
        key: 17
      }, [api_text("Charger:")]), api_element("div", {
        key: 18
      }, [api_text("42V4A")])]), api_element("div", {
        classMap: {
          "row": true
        },
        key: 22
        ...
        key: 20
      }, [api_text("Motor:")]), api_element("div", {
        key: 21
      }, [api_text("250 watt, 75Nm")])]), api_element("section", {
        key: 23
      }, [api_text("Frame")]), api_element("div", {
        classMap: {
          "row": true
        },
        key: 26
        ...
        key: 25
      }, [api_dynamic($cmp.product.data.fields.Material__c.value)])]), api_element("div", {
        classMap: {
          "row": true
        },
        key: 29
        ...
        key: 27
      }, [api_text("Fork:")]), api_element("div", {
        key: 28
      }, [api_text("Air spring, adjustable rebound")])]), api_element("section", {
        key: 30
      }, [api_text("Brakes")]), api_element("div", {
        classMap: {
          "row": true
        },
        key: 33
        ...
        key: 31
      }, [api_text("Front:")]), api_element("div", {
        key: 32
      }, [api_text("Hydraulic disc, 200mm")])]), api_element("div", {
        classMap: {
          "row": true
        },
        key: 36
        ...
        key: 34
      }, [api_text("Rear:")]), api_element("div", {
        key: 35
      }, [api_text("Hydraulic disc, 200mm")])])]) : null, $cmp.noData ? api_custom_element("c-placeholder", _cPlaceholder, {
        props: {
          "message": "Select a product to see details"
        },
        key: 38
      }, []) : null, $cmp.product.error ? api_custom_element("c-inline-message", _cInlineMessage, {
        props: {
          "errors": $cmp.product.error
        },
        key: 39
      }, []) : null])];
    }
    ...
    tmpl$7.stylesheetTokens = {
      hostAttribute: "lwc-productCard_productCard-host",
      shadowAttribute: "lwc-productCard_productCard"
    };
     ...
     * Commerce
     */const getProductAdapter=createLdsAdapter('getProduct',getProductAdapterFactory);const getProduct$1=registerWireAdapter(getProductAdapter);const getProductCategoryPathAdapter=createLdsAdapter('getProductCategoryPath',getProductCategoryPathAdapterFactory);const getProductCategoryPath$1=registerWireAdapter(getProductCategoryPathAdapter);const getProductPriceAdapter=createLdsAdapter('getProductPrice',getProductPriceAdapterFactory);const getProductPrice$1=registerWireAdapter(getProductPriceAdapter);const productSearchAdapter=createLdsAdapter('productSearch',productSearchAdapterFactory);const productSearch$1=registerWireAdapter(productSearchAdapter);const adsBridge=new AdsBridge(lds);const getRecordNotifyChange=throttle(60,60000,notifyChangeFactory(lds),{allowFunction:incrementGetRecordNotifyChangeAllowCount,dropFunction:incrementGetRecordNotifyChangeDropCount});const getRecord$3=getRecord$2;// version: 0.1.10-3dfe453

    var PRODUCT_OBJECT = {"objectApiName":"Product__c"};

    var NAME_FIELD = {"fieldApiName":"Name","objectApiName":"Product__c"};

    var LEVEL_FIELD = {"fieldApiName":"Level__c","objectApiName":"Product__c"};

    var CATEGORY_FIELD = {"fieldApiName":"Category__c","objectApiName":"Product__c"};

    var MATERIAL_FIELD = {"fieldApiName":"Material__c","objectApiName":"Product__c"};

    var MSRP_FIELD = {"fieldApiName":"MSRP__c","objectApiName":"Product__c"};

    var PICTURE_URL_FIELD = {"fieldApiName":"Picture_URL__c","objectApiName":"Product__c"};
    ...
    class ProductCard extends navigation.NavigationMixin(lwc.LightningElement) {
      constructor(...args) {
        super(...args);
      ...
      connectedCallback() {
        pubsub.registerListener('productSelected', this.handleProductSelected, this);
      }
    ...
    lwc.registerDecorators(ProductCard, {
      wire: {
        pageRef: {
    ...
    var productCard = lwc.registerComponent(ProductCard, {
      tmpl: _tmpl$8
    });
